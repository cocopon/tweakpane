...
const ID_TO_THEME_MAP: {[id in ThemeId]: () => Theme} = {
	default: () => ({
		...
		'folder-background-color': 'hsla(230, 7%, 75%, 0.1)',
		'folder-background-color-active': 'hsla(230, 7%, 75%, 0.25)',
		'folder-background-color-focus': 'hsla(230, 7%, 75%, 0.2)',
		'folder-background-color-hover': 'hsla(230, 7%, 75%, 0.15)',
		'folder-foreground-color': 'hsla(230, 7%, 75%, 1)',
