...
(function() {
	...
	pane.addPalette(params, 'color');
	pane.addSlider(params, 'size', {min: 1, max: 100});
	pane.addSlider(params, 'speed', {min: 0.0, max: 1.0});
...
(function() {
	...
	pane.addSlider(params1, 'speed', {
		id: 'target1_speed',
		min: 0.0,
		max: 1.0
	});
	pane.addSlider(params2, 'speed', {
		id: 'target2_speed',
		min: 0.0,
		max: 1.0
	});
