			...
			icebergTheme: (container) => {
				return setUpThemedPane(container, {
					cssProps: [
						...
						'',
						'/* Input control colors */',
						'--tp-input-background-color: hsl(230deg, 28%, 20%);',
						'--tp-input-background-color-active: hsl(230deg, 28%, 35%);',
						'--tp-input-background-color-focus: hsl(230deg, 28%, 30%);',
						'--tp-input-background-color-hover: hsl(230deg, 28%, 25%);',
